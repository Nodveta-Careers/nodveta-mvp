    ...
    try {
      ...
      setBuyerInfo(
        [
          ...
          { id: "NTE Amount", val: ethers.utils.formatUnits(buyerInfo.sale, 18).toString() + " " + tokeninfoarr.symbol},
        ]
      )
    } catch (error) {
      setOpenAlert(true)
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <CardActions sx={{justifyContent: 'center'}}>
              <Typography color="text.secondary" variant="caption" display="block" sx={{fontWeight: 500}}>All NTE purchased can be claimed after the end of the vesting period</Typography>
            </CardActions>
          </Card>
        </Grid>
      </Grid>
