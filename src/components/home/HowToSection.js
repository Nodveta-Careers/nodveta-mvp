...
const steps = [
  {
    ...
    description: '$NTE is available in BSC, Binance Smart Chain networks. Choose your network from here BSC “DROP DOWN MENU” “Same as in toolbar” to participate in $NTE pre-sale',
  },
  {
  ...
  },
  {
    ...
    description: 'You can currently swap BNB to $NTE on Pre-Sale over NTE\'s official website! Pre-Sale supports only BEP20 BNB.',
  },
  {
    label: 'Swap BEP20 $BNB to $NTE',
    description: 'Click Connect Wallet Enter the amount of $BNB you would like to swap for $NTE. Then click on Swap.',
  },
  {
    label: 'Claim $NTE',
    description: 'All $NTE purchased can be claimed at the pre-sale page after the end of the vesting period.',
  },
];
