    ...
    >
      <Container>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 5, maxWidth: 800, mx: 'auto', textAlign: 'center' }}>
          During the presale, you will have the option to buy $NTE, presale will take place in two steps with different price, presale supports only BEP20 $BNB. All $NTE purchased can be claimed at the pre-sale page after the end of the vesting period.
        </Typography>
        <Typography 
          variant="h3" 
          component="div" 
