...
// ASSESSMENT_TASK_3: Fetch and display total mint count via nftMarketplaceService
...
const GalleryItems = () => {
  ...
  return (
    <Fragment>
      <StatBar
        items={[
          { label: "Total Minted", value: "—", highlight: true },
          { label: "Listed Items", value: items.length },
