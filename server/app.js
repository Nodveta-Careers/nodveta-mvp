...
// MongoDB Connection
const MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost:27017/nodemeta-mvp";
...
.then(() => {
  loggerHelper.requestLogger.info('Connected to MongoDB successfully');
})
.catch((err) => {
  loggerHelper.errorLogger.error('MongoDB connection error:', err);
